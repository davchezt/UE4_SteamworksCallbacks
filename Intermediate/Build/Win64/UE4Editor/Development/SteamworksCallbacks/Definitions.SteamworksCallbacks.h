...
#define ORIGINAL_FILE_NAME "UE4Editor-SteamworksCallbacks.dll"
#define UE_IS_ENGINE_MODULE 0
#define UE_BUILD_DEVELOPMENT_WITH_DEBUGGAME 0
#define UE_PROJECT_NAME ProjectSpaceWars
...
#define STEAMSDK_FOUND 1
#define WITH_STEAMWORKS 1
#define STEAMWORKSCALLBACKS_API DLLEXPORT
